...
const groups = [
  ...
  { title: "Data maintenance", adminOnly: true, items: [
    { href: "/settings/data-reset", title: "Reset workflow test data", body: "Clear enquiries, surveys, quotes, artwork, production and calendar data while keeping configured master data.", icon: "!" }
  ]}
];
