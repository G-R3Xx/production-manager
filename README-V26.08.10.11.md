# Production Manager V26.08.10.11
...
## V26.08.10.11
- Added inline MYOB customer linking directly on an accepted quote.
- Quotes with an unmapped client now show a MYOB customer selector instead of only a blocking sync error.
- Supports Link customer or Link & send to MYOB in one step.
- Clears the stale MYOB sync error after a successful link and marks the quote ready to sync.
- Suggests a unique exact company/email MYOB match when available.
