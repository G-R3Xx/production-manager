...
export const tenantSettings = appSchema.table("tenant_settings", {
  ...
  myobPurchaseExpenseAccountName: varchar("myob_purchase_expense_account_name", { length: 255 }),
  myobPurchaseExpenseAccountDisplayId: varchar("myob_purchase_expense_account_display_id", { length: 30 }),
  myobPurchaseTaxCodeUid: varchar("myob_purchase_tax_code_uid", { length: 255 }),
  myobPurchaseTaxCode: varchar("myob_purchase_tax_code", { length: 20 }),
