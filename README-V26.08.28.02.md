# Production Manager V26.08.28.02
...
## V26.08.28.02 build fix
- Fixed the MYOB Plan Printing price-matrix TypeScript build error by allowing the shared numeric parser to safely accept unknown JSON values from MYOB `SellingPrices`.
